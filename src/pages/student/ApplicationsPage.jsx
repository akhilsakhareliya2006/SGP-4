...
function ApplicationsPage() {
  ...
  const renderBadge = (filter) => {
    ...
    switch (filter) {
      case "hired": return <span style={{ ...style, backgroundColor: '#dcfce7', color: '#166534', border: '1px solid #bbf7d0' }}><FiCheckCircle size={14} /> Hired</span>;
      ...
      case "shortlisted": return <span style={{ ...style, backgroundColor: '#eff6ff', color: '#1d4ed8', border: '1px solid #bfdbfe' }}><FiStar size={14} /> Shortlisted</span>;
      ...
      <div style={{ height: 'calc(100vh - 40px)', width: '100%', display: 'flex', flexDirection: 'column', overflow: 'hidden', backgroundColor: '#f8fafc' }}>
        <div className="employees-page" style={{ flexGrow: 1, overflowY: 'auto', padding: '2rem' }}>
          ...
          <div style={{ marginBottom: '2rem' }}>
            <h2 style={{ fontSize: '2.2rem', fontWeight: 800, color: '#0f172a', margin: '0 0 0.5rem 0' }}>My Applications</h2>
            <p style={{ fontSize: '1.05rem', color: '#64748b', margin: 0 }}>Track your application status and company feedback.</p>
          </div>
          ...
          <div style={{ background: '#fff', padding: '2rem', borderRadius: '16px', border: '1px solid #e2e8f0', marginBottom: '2.5rem', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
              <span style={{ fontSize: '0.8rem', fontWeight: 800, color: '#94a3b8', textTransform: 'uppercase', letterSpacing: '1px' }}>Application Status</span>
          ...
          {loading ? (
            <div style={{ padding: '4rem 0', textAlign: 'center', color: '#64748b', fontSize: '1.2rem', fontWeight: 600 }}>Loading your applications...</div>
            ...
            <div style={{ padding: '5rem 2rem', textAlign: 'center', backgroundColor: '#fff', borderRadius: '16px', border: '2px dashed #cbd5e1' }}>
              ...
              <p style={{ margin: 0, color: '#64748b', fontSize: '1.05rem' }}>You have no applications matching the '{activeFilter}' status.</p>
            </div>
          ) : (
                ...
                >
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', marginBottom: '1.5rem', flexGrow: 1, marginTop: '1rem' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px', color: '#475569', fontSize: '0.95rem', fontWeight: 500 }}>
                      ...
                      Applied for: {formatDate(job.dueDate)}
                    </div>
                  </div>
